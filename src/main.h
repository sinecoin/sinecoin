...
#endif
/** SineCoin function parameters **/
static const unsigned int SINAMPLITUDE = 25;
static const unsigned int SINPERIOD = 576; // 2-day cycle
static const unsigned int SINBASE = 100; // y-intercept
